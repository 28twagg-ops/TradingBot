...
_Generated 2026-07-29T10:49:24.696110_
...
| S202 (GapDown_Monster) | 3d ATM gap-monster | watch | 0 | 0.0 | +0.00 | +0.00 | +0.00 | +0.00 | 1 | 12 | 0 | $+0.00 | 0.0% | insufficient sample (<8 exits) |
| S203 (GapUp_Fade) | 3d ATM gap-up fade (put) | watch | 0 | 0.0 | +0.00 | +0.00 | +0.00 | +0.00 | 2 | 6 | 0 | $+0.00 | 0.0% | insufficient sample (<8 exits) |
...
| S209 (GapDown_Recovery) | 3d ATM gap-recovery | watch | 0 | 0.0 | +0.00 | +0.00 | +0.00 | +0.00 | 0 | 4 | 0 | $+0.00 | 0.0% | insufficient sample (<8 exits) |
| S210 (MA_Cross_8_21) | 3d ATM MA cross 8/21 | watch | 0 | 0.0 | +0.00 | +0.00 | +0.00 | +0.00 | 2 | 13 | 0 | $+0.00 | 0.0% | insufficient sample (<8 exits) |
| S211 (MA_Cross_21_50) | 3d ATM MA cross 21/50 | watch | 0 | 0.0 | +0.00 | +0.00 | +0.00 | +0.00 | 2 | 6 | 0 | $+0.00 | 0.0% | insufficient sample (<8 exits) |
...
| S216 (RSI_Oversold_Cross) | 3d ATM RSI x30 | watch | 0 | 0.0 | +0.00 | +0.00 | +0.00 | +0.00 | 2 | 18 | 0 | $+0.00 | 0.0% | insufficient sample (<8 exits) |
...
| S164 (GapDown ATM 1-DTE — P2B arm) | 1d ATM | watch | 6 | 0.0 | -65.67 | -88.89 | -86.11 | -50.00 | 8 | 16 | 0 | $-59.00 | 83.3% | insufficient sample (<8 exits) |
...
| S164 | 1d ATM | 6 | -65.67 | -88.89 | -86.11 | 16 | 0 |
...
| S202 | 3d ATM gap-monster | 0 | +0.00 | +0.00 | +0.00 | 12 | 0 |
...
| strategy | DTE profile | exits | med% | p10% | p25% | entries 5d | exits 5d |
|---|---|---:|---:|---:|---:|---:|---:|
| S203 | 3d ATM gap-up fade (put) | 0 | +0.00 | +0.00 | +0.00 | 6 | 0 |
...
| strategy | DTE profile | exits | med% | p10% | p25% | entries 5d | exits 5d |
|---|---|---:|---:|---:|---:|---:|---:|
| S210 | 3d ATM MA cross 8/21 | 0 | +0.00 | +0.00 | +0.00 | 13 | 0 |
| S211 | 3d ATM MA cross 21/50 | 0 | +0.00 | +0.00 | +0.00 | 6 | 0 |
| S212 | 3d ATM MA bounce 50 | 0 | +0.00 | +0.00 | +0.00 | 16 | 0 |
...
| strategy | DTE profile | exits | med% | p10% | p25% | entries 5d | exits 5d |
|---|---|---:|---:|---:|---:|---:|---:|
| S216 | 3d ATM RSI x30 | 0 | +0.00 | +0.00 | +0.00 | 18 | 0 |
| S217 | 3d ATM RSI<25 bounce | 0 | +0.00 | +0.00 | +0.00 | 10 | 0 |
| S218 | 3d ATM BB lower touch | 0 | +0.00 | +0.00 | +0.00 | 16 | 0 |
