...
_Generated 2026-08-07T11:22:54.445032_
...
- Total exits: **1986**
- Orphan exits (b0/orphan_reconcile): **186**
...
| S218 (BB_Lower_Touch) | 3d ATM BB lower touch | watch | 45 | 66.7 | +50.00 | -73.77 | -52.94 | +208.09 | 11 | 76 | 43 | $+879.00 | 40.0% | fat left tail (p10 < -45%) |
...
| S356 (GapDown_14DTE) | 14d | watch | 5 | 80.0 | +37.93 | -12.61 | +37.93 | +58.62 | 7 | 24 | 3 | $+87.00 | 100.0% | insufficient sample (<8 exits) |
| S408 (RubberBand_ITM1) | 3d | watch | 34 | 52.9 | +37.63 | -65.73 | -50.00 | +910.19 | 4 | 72 | 34 | $+1,276.00 | 29.4% | fat left tail (p10 < -45%) |
| S354 (GapDown_5DTE) | 5d | watch | 28 | 50.0 | +30.15 | -72.13 | -65.00 | +152.73 | 7 | 36 | 14 | $+628.00 | 28.6% | fat left tail (p10 < -45%) |
| S401 (Any_Gap_Down_Small) | 3d | watch | 49 | 59.2 | +23.68 | -96.23 | -28.95 | +182.62 | 7 | 77 | 47 | $+868.00 | 30.6% | fat left tail (p10 < -45%) |
| S210 (MA_Cross_8_21) | 3d ATM MA cross 8/21 | watch | 40 | 57.5 | +10.79 | -58.81 | -42.69 | +53.93 | 11 | 80 | 40 | $-5.00 | 37.5% | fat left tail (p10 < -45%) |
| S363 (RubberBand_5DTE) | 5d | watch | 15 | 73.3 | +9.52 | -71.46 | -23.36 | +87.65 | 4 | 42 | 15 | $+30.00 | 40.0% | building sample (8-19 exits) |
| S411 (RubberBand_OTM2) | 3d | watch | 24 | 54.2 | +6.57 | -57.76 | -52.08 | +43.00 | 4 | 64 | 24 | $-156.00 | 37.5% | fat left tail (p10 < -45%) |
...
| S365 (RubberBand_14DTE) | 14d | watch | 5 | 40.0 | -51.61 | -83.58 | -83.58 | +153.94 | 7 | 26 | 5 | $-44.00 | 40.0% | insufficient sample (<8 exits) |
...
| S405 (GapDown_OTM3) | 3d | drop | 38 | 47.4 | -21.05 | -59.22 | -48.71 | +111.52 | 7 | 59 | 24 | $+336.00 | 36.8% | non-positive median return |
...
| S216 (RSI_Oversold_Cross) | 3d ATM RSI x30 | drop | 28 | 10.7 | -57.12 | -87.48 | -76.98 | -7.36 | 11 | 58 | 28 | $-699.00 | 50.0% | non-positive median return |
| S212 (MA_Bounce_50) | 3d ATM MA bounce 50 | drop | 58 | 5.2 | -71.89 | -98.45 | -97.94 | -45.99 | 11 | 73 | 58 | $-2,133.00 | 37.9% | non-positive median return |
...
| strategy | DTE profile | exits | med% | p10% | p25% | entries 5d | exits 5d |
|---|---|---:|---:|---:|---:|---:|---:|
| S210 | 3d ATM MA cross 8/21 | 40 | +10.79 | -58.81 | -42.69 | 80 | 40 |
| S211 | 3d ATM MA cross 21/50 | 21 | -31.58 | -97.22 | -48.72 | 64 | 21 |
| S212 | 3d ATM MA bounce 50 | 58 | -71.89 | -98.45 | -97.94 | 73 | 58 |
...
| strategy | DTE profile | exits | med% | p10% | p25% | entries 5d | exits 5d |
|---|---|---:|---:|---:|---:|---:|---:|
| S216 | 3d ATM RSI x30 | 28 | -57.12 | -87.48 | -76.98 | 58 | 28 |
| S217 | 3d ATM RSI<25 bounce | 29 | -10.00 | -61.75 | -55.00 | 50 | 28 |
| S218 | 3d ATM BB lower touch | 45 | +50.00 | -73.77 | -52.94 | 76 | 43 |
...
| S216 | RSI_Oversold_Cross | 28 | -57.12% | 11% | INSUFFICIENT | 11 |
...
| S356 | GapDown_14DTE | 5 | +37.93% | 80% | WATCH | 7 |
...
| S365 | RubberBand_14DTE | 5 | -51.61% | 40% | WATCH | 7 |
...
| S405 | GapDown_OTM3 | 38 | -21.05% | 47% | INSUFFICIENT | 7 |
