...
_Generated 2026-08-10T10:08:12.034408_
...
- Total exits: **2070**
- Orphan exits (b0/orphan_reconcile): **214**
- Orphan rate: **10.3%** (warn if >10%)
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| S406 (RubberBand_ITM3) | 3d | watch | 49 | 59.2 | +63.64 | -63.83 | -51.22 | +965.79 | 10 | 26 | 2 | $+2,811.00 | 26.5% | fat left tail (p10 < -45%) |
| S357 (GapDown_21DTE) | 21d | watch | 16 | 87.5 | +58.87 | -17.77 | +47.06 | +73.68 | 10 | 0 | 4 | $+400.00 | 50.0% | building sample (8-19 exits) |
| S364 (RubberBand_7DTE) | 7d | watch | 27 | 66.7 | +57.58 | -65.00 | -43.27 | +188.89 | 10 | 19 | 4 | $+375.00 | 44.4% | fat left tail (p10 < -45%) |
| S397 (GapDown_ITM1) | 3d | watch | 11 | 81.8 | +51.39 | -91.67 | +39.48 | +116.39 | 10 | 5 | 2 | $+345.00 | 63.6% | building sample (8-19 exits) |
...
| S408 (RubberBand_ITM1) | 3d | watch | 36 | 55.6 | +43.55 | -64.09 | -50.00 | +880.61 | 7 | 22 | 2 | $+1,282.00 | 27.8% | fat left tail (p10 < -45%) |
| S352 (GapDown_2DTE) | 2d | watch | 24 | 62.5 | +39.01 | -64.86 | -51.85 | +128.43 | 10 | 16 | 11 | $+245.00 | 25.0% | fat left tail (p10 < -45%) |
| S404 (GapDown_OTM2) | 3d | watch | 17 | 58.8 | +38.60 | -98.18 | -91.67 | +113.61 | 10 | 2 | 7 | $+113.00 | 52.9% | building sample (8-19 exits) |
...
| S355 (GapDown_7DTE) | 7d | watch | 31 | 51.6 | +34.69 | -66.67 | -57.09 | +187.50 | 10 | 9 | 6 | $+521.00 | 35.5% | fat left tail (p10 < -45%) |
| S401 (Any_Gap_Down_Small) | 3d | watch | 53 | 58.5 | +23.68 | -89.36 | -38.98 | +160.00 | 10 | 30 | 10 | $+944.00 | 34.0% | fat left tail (p10 < -45%) |
| S210 (MA_Cross_8_21) | 3d ATM MA cross 8/21 | watch | 44 | 59.1 | +13.89 | -55.87 | -35.52 | +71.92 | 14 | 20 | 8 | $+44.00 | 34.1% | fat left tail (p10 < -45%) |
...
| S353 (GapDown_3DTE) | 3d | watch | 19 | 36.8 | -34.69 | -86.52 | -77.44 | +123.68 | 10 | 2 | 5 | $-105.00 | 47.4% | early sample with non-positive median |
...
| S358 (GapDown_30DTE) | 30d | watch | 1 | 0.0 | -51.39 | -51.39 | -51.39 | -51.39 | 6 | 0 | 1 | $-37.00 | 100.0% | insufficient sample (<8 exits) |
...
| S354 (GapDown_5DTE) | 5d | drop | 32 | 43.8 | -35.71 | -76.37 | -70.72 | +142.73 | 10 | 18 | 5 | $+462.00 | 37.5% | non-positive median return |
...
| S351 (GapDown_1DTE) | 1d | drop | 38 | 26.3 | -52.55 | -80.48 | -66.52 | +171.88 | 10 | 18 | 5 | $+7.00 | 34.2% | non-positive median return |
| S203 (GapUp_Fade) | 3d ATM gap-up fade (put) | drop | 33 | 12.1 | -54.00 | -79.08 | -74.42 | +38.86 | 14 | 12 | 5 | $-717.00 | 42.4% | non-positive median return |
| S407 (RubberBand_ITM2) | 3d | drop | 29 | 37.9 | -54.05 | -88.38 | -61.54 | +367.28 | 10 | 8 | 6 | $+161.00 | 31.0% | non-positive median return |
| S360 (RubberBand_1DTE) | 1d | drop | 34 | 8.8 | -55.16 | -81.64 | -70.96 | -33.33 | 10 | 16 | 7 | $-612.00 | 32.4% | non-positive median return |
| S216 (RSI_Oversold_Cross) | 3d ATM RSI x30 | drop | 30 | 10.0 | -56.25 | -87.23 | -75.81 | -27.09 | 14 | 26 | 9 | $-733.00 | 53.3% | non-positive median return |
...
| strategy | DTE profile | exits | med% | p10% | p25% | entries 5d | exits 5d |
|---|---|---:|---:|---:|---:|---:|---:|
| S203 | 3d ATM gap-up fade (put) | 33 | -54.00 | -79.08 | -74.42 | 12 | 5 |
...
| strategy | DTE profile | exits | med% | p10% | p25% | entries 5d | exits 5d |
|---|---|---:|---:|---:|---:|---:|---:|
| S210 | 3d ATM MA cross 8/21 | 44 | +13.89 | -55.87 | -35.52 | 20 | 8 |
...
| strategy | DTE profile | exits | med% | p10% | p25% | entries 5d | exits 5d |
|---|---|---:|---:|---:|---:|---:|---:|
| S216 | 3d ATM RSI x30 | 30 | -56.25 | -87.23 | -75.81 | 26 | 9 |
...
| S210 | MA_Cross_8_21 | 44 | +13.89% | 59% | INSUFFICIENT | 14 |
...
| S401 | Any_Gap_Down_Small | 53 | +23.68% | 58% | INSUFFICIENT | 10 |
...
| S406 | RubberBand_ITM3 | 49 | +63.64% | 59% | INSUFFICIENT | 10 |
...
| S355 | 31 | +34.69% | 52% | Tyler review |
| S401 | 53 | +23.68% | 58% | Tyler review |
| S210 | 44 | +13.89% | 59% | Tyler review |
