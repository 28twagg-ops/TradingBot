...
_Generated 2026-09-08T11:37:20.182507_
...
| S163 (A1 GapDown ATM call EOD) | 7d ATM | watch | 10 | 100.0 | +81.92 | +72.16 | +76.22 | +200.57 | 49 | 8 | 1 | $+441.00 | 50.0% | building sample (8-19 exits) |
...
| S403 (Any_MA50_Touch) | 3d | watch | 44 | 65.9 | +50.93 | -63.07 | -49.10 | +236.83 | 39 | 10 | 2 | $+890.00 | 20.5% | fat left tail (p10 < -45%) |
| S404 (GapDown_OTM2) | 3d | watch | 45 | 64.4 | +50.00 | -91.67 | -41.89 | +117.95 | 39 | 15 | 5 | $+789.00 | 20.0% | fat left tail (p10 < -45%) |
| S361 (RubberBand_2DTE) | 2d | watch | 41 | 56.1 | +44.83 | -68.52 | -53.33 | +253.33 | 39 | 6 | 0 | $+212.00 | 26.8% | fat left tail (p10 < -45%) |
...
| S352 (GapDown_2DTE) | 2d | watch | 41 | 51.2 | +13.04 | -75.00 | -51.85 | +341.67 | 39 | 6 | 3 | $+149.00 | 26.8% | fat left tail (p10 < -45%) |
...
| S210 (MA_Cross_8_21) | 3d ATM MA cross 8/21 | watch | 74 | 50.0 | +1.32 | -79.88 | -50.53 | +74.20 | 43 | 12 | 4 | $-64.00 | 20.3% | fat left tail (p10 < -45%) |
...
| S411 (RubberBand_OTM2) | 3d | drop | 33 | 48.5 | +0.00 | -56.72 | -51.67 | +37.88 | 36 | 10 | 0 | $-321.00 | 27.3% | non-positive median return |
...
| S399 (GapDown_OTM1) | 3d | drop | 56 | 48.2 | -31.70 | -84.41 | -66.67 | +183.25 | 39 | 17 | 3 | $+113.00 | 28.6% | non-positive median return |
...
- Status: **OK** | Best median: **S168** (+137.84%) | Best p10: **S163** (+72.16%)

| strategy | DTE profile | exits | med% | p10% | p25% | entries 5d | exits 5d |
|---|---|---:|---:|---:|---:|---:|---:|
| S163 | 7d ATM | 10 | +81.92 | +72.16 | +76.22 | 8 | 1 |
...
| strategy | DTE profile | exits | med% | p10% | p25% | entries 5d | exits 5d |
|---|---|---:|---:|---:|---:|---:|---:|
| S210 | 3d ATM MA cross 8/21 | 74 | +1.32 | -79.88 | -50.53 | 12 | 4 |
...
|----------|--------|---|---------|-----|--------|------|
| S163 | A1 GapDown ATM call EO | 10 | +81.92% | 100% | WATCH | 49 |
...
| S210 | MA_Cross_8_21 | 74 | +1.32% | 50% | INSUFFICIENT | 43 |
...
| S352 | GapDown_2DTE | 41 | +13.04% | 51% | INSUFFICIENT | 39 |
...
| S399 | GapDown_OTM1 | 56 | -31.70% | 48% | INSUFFICIENT | 39 |
...
| S352 | 41 | +13.04% | 51% | Tyler review |
| S401 | 96 | +8.97% | 52% | Tyler review |
| S398 | 48 | +3.33% | 52% | Tyler review |
| S210 | 74 | +1.32% | 50% | Tyler review |
