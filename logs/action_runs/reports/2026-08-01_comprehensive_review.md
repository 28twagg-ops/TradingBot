# Daily Comprehensive Action Review — 2026-08-01

_Auto-generated from GitHub Actions run output. This document appends every run for the day._

## Run 20260801T011923Z

- UTC timestamp: `20260801T011923Z`
- GitHub run: [#5816](https://github.com/28twagg-ops/TradingBot/actions/runs/30677632858)
- Run id: `30677632858`
...
```text
01:19:24  INFO      Mode: weekly
01:19:24  INFO        Weekly summary -> logs/weekly/2026-W31.md
...
|  Buys today                                                           0|
|  Cash-based cap            12979 max trades with current available cash|
+------------------------------------------------------------------------+
|  Equity           $469.81       Cash             $153.29               |
|  Invested         $316.52       Available        $129.80               |
|  Open P&L         $+3.21        Realized P&L     $-13.02               |
+------------------------------------------------------------------------+
|  This week         0 buys  |  47 sells  |  Win rate 30%  |  P&L $-12.74|
|  All t~  1064 trades  |  Avg hold 1.8d  |  Return -7.7%  |  P&L $-13.02|
+------------------------------------------------------------------------+
|  TICKER  STRATEGY       INVESTED   ENTRY     NOW       P&L%      P&L$  |
+------------------------------------------------------------------------+
|  APG     MomReversal    $32.29     $38.85    $39.68    +2.1%     $+0.68|
|  CINF    Pullback50     $95.35     $175.04   $177.68   +1.5%     $+1.41|
|  MP      MomReversal    $94.19     $41.37    $41.51    +0.3%     $+0.31|
|  PWR     EarningsDrift  $94.68     $667.29   $673.00   +0.9%     $+0.80|
+------------------------------------------------------------------------+
...
options_reconcile: state=/home/runner/work/TradingBot/TradingBot/logs/options_trial/_state/lab_state.json
  ...
  alpaca positions=14
  FLAG b284|S351|78a482c7 missing from Alpaca
...
Buckets:      1024
=== options_morning_bot (PAPER) 2026-07-31T21:19:26.840600-04:00 ===

[Run context]
After hours (21:19 ET) — exit summary only.
Paper auth OK — equity $135581.48, account PA36KS87UPRS
...
|  Today     trades=80  avg=+71.1%  med=+55.1%  real=$+2,886.00          |
+------------------------------------------------------------------------+
...
STATUS: options_morning_bot after-hours summary (PAPER) elapsed=0.6s. run=#5816 https://github.com/28twagg-ops/TradingBot/actions/runs/30677632858
...
Summary: 80 buckets closed trades, $+2,886.00 realized
...
_Generated 2026-07-31T21:19:33.083207_
...
equity=469.22 router=CONFIRMED leaderboard_rows=105
